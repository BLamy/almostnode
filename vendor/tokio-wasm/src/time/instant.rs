...
type InnerInstant = web_time::Instant;
...
impl Instant {
    ...
    fn from_inner(std: InnerInstant) -> Instant {
        Instant { std }
    }
    ...
    pub fn into_std(self) -> std::time::Instant {
        ...
        {
            let _ = self;
            panic!("tokio::time::Instant::into_std is unavailable in wasm32-unknown-unknown");
        }
    ...
    pub fn checked_add(&self, duration: Duration) -> Option<Instant> {
        self.std.checked_add(duration).map(Instant::from_inner)
    }
    ...
    pub fn checked_sub(&self, duration: Duration) -> Option<Instant> {
        self.std.checked_sub(duration).map(Instant::from_inner)
    }
}
...
impl ops::Add<Duration> for Instant {
    ...
    fn add(self, other: Duration) -> Instant {
        Instant::from_inner(self.std + other)
    }
}
...
impl ops::Sub<Duration> for Instant {
    ...
    fn sub(self, rhs: Duration) -> Instant {
        Instant::from_inner(self.std - rhs)
    }
}
...
mod variant {
    ...
    pub(super) fn now() -> Instant {
        Instant::from_inner(super::InnerInstant::now())
    }
}
