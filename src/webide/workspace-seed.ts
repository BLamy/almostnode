...
`,
  [`${WORKSPACE_ROOT}/schema.sql`]: `-- PGlite schema: runs automatically on database init
...
`,
  [`${WORKSPACE_ROOT}/src/hooks/useDB.ts`]: `import { useState, useEffect, useCallback } from 'react';
